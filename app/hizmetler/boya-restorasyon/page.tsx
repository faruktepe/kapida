...
const ADIMLAR = ["Ayakkabı teslim alınır ve renk analizi yapılır", "Yüzey temizlenir ve hazırlanır", "Profesyonel boya uygulanır", "Kurutma ve sabitleme işlemi", "Koruyucu kaplama ve teslim"];
    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 pt-28 pb-24">
        <div className="border-b border-black/8 pb-12 mb-12">
          <p className="text-[10px] uppercase tracking-[0.4em] text-black/25 mb-3">02 · Hizmet</p>
          <h1 className="text-4xl md:text-7xl font-bold tracking-tight leading-none mb-6">Boya & Restorasyon</h1>
          <p className="text-base text-black/50 max-w-lg leading-relaxed mb-8">Rengi solmuş, çizilmiş veya yıpranmış ayakkabılar için profesyonel renk yenileme ve restorasyon hizmeti.</p>
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <div className="flex gap-6">
              <div><p className="text-2xl font-bold">₺1.200+</p><p className="text-[10px] text-black/30 mt-0.5 uppercase tracking-wider">Başlangıç</p></div>
