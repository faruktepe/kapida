...
const DETAYLAR = ["Dikiş tamiri ve yenileme", "Çoraplık (iç astar) onarımı", "Fort ve ökçe tamiri", "Yırtık onarımı", "Fermuvar tamiri"];
    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 pt-28 pb-24">
        <div className="border-b border-black/8 pb-12 mb-12">
          <p className="text-[10px] uppercase tracking-[0.4em] text-black/25 mb-3">04 · Hizmet</p>
          <h1 className="text-4xl md:text-7xl font-bold tracking-tight leading-none mb-6">Dikiş & Onarım</h1>
          <p className="text-base text-black/50 max-w-lg leading-relaxed mb-8">Sökülen dikişler, yırtılan yerler ve küçük hasarlar için hızlı ve kalıcı onarım hizmeti.</p>
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <div className="flex gap-6">
              <div><p className="text-2xl font-bold">₺250+</p><p className="text-[10px] text-black/30 mt-0.5 uppercase tracking-wider">Başlangıç</p></div>
              <div><p className="text-2xl font-bold">1–2 gün</p><p className="text-[10px] text-black/30 mt-0.5 uppercase tracking-wider">Süre</p></div>
            </div>
          </div>
        </div>
