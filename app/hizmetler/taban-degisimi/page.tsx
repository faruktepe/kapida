    ...
    <main className="min-h-screen" style={{background: BG, color: DRK}}>
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 pt-28 pb-24">
        <div className="pb-12 mb-12" style={{borderBottom:`1px solid ${STN}`}}>
          <p className="text-[10px] uppercase tracking-[0.4em] mb-3" style={{color:`rgba(45,26,46,0.25)`}}>03 · Hizmet</p>
          <h1 className="text-4xl md:text-7xl font-black tracking-tight leading-none mb-6" style={{color: DRK}}>Taban Değişimi</h1>
          <p className="text-base max-w-lg leading-relaxed mb-8" style={{color:`rgba(45,26,46,0.5)`}}>Aşınmış veya yırtılmış tabanları tamamen yeniliyoruz. Her marka ve model için uygun seçenek.</p>
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <div className="flex gap-6">
              <div>
                <p className="text-2xl font-black" style={{color: ACCENT}}>₺600+</p>
                <p className="text-[10px] mt-0.5 uppercase tracking-wider" style={{color:`rgba(45,26,46,0.3)`}}>Başlangıç</p>
              </div>
              <div>
                <p className="text-2xl font-black" style={{color: MUV}}>2-3 gün</p>
