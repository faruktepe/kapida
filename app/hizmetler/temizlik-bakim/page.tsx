...
const ADIMLAR  = ["Kapınızdan teslim alınır","Analiz ve fotoğraflama yapılır","Buhar temizlik uygulanır","Cila ve koruma katmanı eklenir","Paketlenerek kapınıza teslim edilir"];
    ...
    <main className="min-h-screen" style={{background: BG, color: DRK}}>
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 pt-28 pb-24">
        <div className="pb-12 mb-12" style={{borderBottom:`1px solid ${STN}`}}>
          <p className="text-[10px] uppercase tracking-[0.4em] mb-3" style={{color:`rgba(45,26,46,0.25)`}}>01 · Hizmet</p>
          <h1 className="text-4xl md:text-7xl font-black tracking-tight leading-none mb-6" style={{color: DRK}}>Temizlik & Bakım</h1>
          <p className="text-base max-w-lg leading-relaxed mb-8" style={{color:`rgba(45,26,46,0.5)`}}>Ayakkabınızı fabrika çıkışı gibi yeniliyoruz. Buhar temizlik, derin cila ve UV sterilizasyon ile tertemiz teslim.</p>
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <div className="flex gap-6">
              <div>
                <p className="text-2xl font-black" style={{color: ACCENT}}>₺800+</p>
                <p className="text-[10px] mt-0.5 uppercase tracking-wider" style={{color:`rgba(45,26,46,0.3)`}}>Başlangıç</p>
              </div>
              <div>
                <p className="text-2xl font-black" style={{color: MUV}}>1-2 gün</p>
